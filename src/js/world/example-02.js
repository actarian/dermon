...
import { cm, DEBUG, deg, mm, TEST_ENABLED, VR_ENABLED } from '../threejs/const';
import RoundBoxGeometry from '../threejs/geometries/round-box.geometry';
import Emittable from '../threejs/interactive/emittable';
import FreezableGroup from '../threejs/interactive/freezable.group';
import FreezableMesh from '../threejs/interactive/freezable.mesh';
import GrabbableGroup from '../threejs/interactive/grabbable.group';
import InteractiveMesh from '../threejs/interactive/interactive.mesh';
import Materials from '../threejs/materials/materials';
// import Physics from '../threejs/physics/physics';
import PhysicsWorker from '../threejs/physics/physics.worker';
import Controllers from '../threejs/vr/controllers';
import { GAMEPAD_HANDS } from '../threejs/vr/gamepads';
import { VR, VR_MODE } from '../threejs/vr/vr';
...
export default class Example02 extends Emittable {
	...
	static init() {
		[...document.querySelectorAll('[example-02]')].map(x => new Example02(x));
	}
